<template>
	<view>
		<u-navbar title="家政详情" :border="true" :placeholder="true"   :autoBack="true"></u-navbar>
		<scroll-view :enable-flex="true" class="svcontainer">
			...
			<view class="hpaddingctn">
				<button @click="toChat" type="default">咨询Shop</button>
			</view>
			...
			<view class="hpaddingctn" v-show="showpl">
				<tn-button @click="replay()" backgroundColor="tn-bg-blue" fontColor="#FFFFFF" width="100%">提交评价
				</tn-button>
			</view>
			
			
			<view class="footerctn">
				<navigator url="#" class="gmbtn" @click="goumai()">立即订单</navigator>
