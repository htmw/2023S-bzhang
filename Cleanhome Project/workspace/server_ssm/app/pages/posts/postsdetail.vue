<template>
	<view>
		<u-navbar title="details" :border="true" :placeholder="true"   :autoBack="true"></u-navbar>
		<scroll-view :enable-flex="true" class="svcontainer">
			<image v-if="fobj.img" style="width: 100%;" :src="fileUrl+fobj.img" mode="widthFix"></image>
			<view class="formitem">
				<view class="gprice">title:{{fobj.title}}</view>
			</view>
			<view class="formitem">
			...
			<view class="hpaddingctn">
				<u-button @click="toChat()" text="Private letter"></u-button>
			</view>
