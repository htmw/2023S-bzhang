<template>
	<view>
		<u-navbar :title="fobj.username" :border="true" :placeholder="true"   :autoBack="true"></u-navbar>
		<scroll-view :enable-flex="true" class="svcontainer">
			...
			<view class="formitem">
				<view class="formlabel">phone number:{{fobj.tel}}</view>
			</view>
			...
			<view class="footerctn">
				...
				<navigator url="#" class="gmbtn" @click="userGoods(fobj.id)">家政List</navigator>
...
<script>
	...
	export default {
		...
		methods: {
			...mapActions(['setCar']),
			fobjDetail() {
				findj({params: {table: 'user', id: this.pid}}).then(res => {
					this.fobj = res
