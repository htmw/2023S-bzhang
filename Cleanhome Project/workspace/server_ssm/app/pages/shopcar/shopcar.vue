<template>
	<view>
		<u-navbar title="shopping cart" :border="true" leftIconSize="0" :placeholder="true" :autoBack="true"></u-navbar>
		<scroll-view :enable-flex="true" class="svcontainer">
					...
					<view class="caritem" v-for="(item,index) in carlist" :key="index">
						...
						<view  class="carinfo">
							<view class="cartitletop">
								...
								<view class="caropctn">
									<u-button type="error" size="mini" text="remove" @click="delCar(item.id)" />
								</view>
							</view>
		  ...
		  <!-- #ifdef MP-WEIXIN  || APP-PLUS -->
				<view class="footerctn">
					<navigator url="#" class="gmbtn" @click="tijiaoBtn()">settlement</navigator>
					<view class="hejictn"><text>total:</text><text class="totalprice">{{totalprice}}</text></view>
				</view>
			<!-- #endif -->
			<!-- #ifdef H5 -->
