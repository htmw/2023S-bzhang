<template>
	<view>
		...
		<scroll-view :enable-flex="true" class="svcontainer">
			...
			<!--<view class="formitem">
				<view class="formlabel" style="color: red;">order time:{{fobj.ydate}}</view>
			</view>-->
			<view class="formitem">
				<view class="formlabel">order date:{{fobj.ndate}}</view>
			</view>
			<view class="formitem" v-if="fobj.qid">
				<view class="formlabel">Distributor Information:{{fobj.qusername+" "+fobj.qtel}}</view>
			</view>
			<view class="formitem" v-if="fobj.statecn==='paid'">
				<view class="hpaddingctn">
					...
					<!--<u-button type="error" @click="changeBillStatecn('rejected')" text="rejected"></u-button>-->
				</view>
			</view>
