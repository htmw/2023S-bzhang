<template>
	<view>
		...
		<view v-if="fileType==0" class="choosefilebtn" @click="toChooseFile()">
			...
			<view class="sftext">Select a document</view>
		</view>
		<view>
			<nk-select-file btnText="Confirm selection" v-model="nkshow" @confirm="getPath"></nk-select-file>
		</view>
	</view>
</template>
