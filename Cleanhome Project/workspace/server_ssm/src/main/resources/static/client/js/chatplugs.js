...
function showUserInfo(){
    ...
    checkIsMyFriend();
    $("#vusername2").text("UserName:"+focususer.username);
    ...
    $("#vemail2").attr("href","tel:"+focusobj.tel).text("Phone Number:"+focususer.tel);
}
...
function toYzMessage(id){
    ...
    if(msg){
        ...
        $("#vstatus").text("Status:"+msg.status);
...
function agree(){
    ajaxCallback("saveJ",{id:focusobj.id,status:"Received",table:"yzmessage"},function(data){
...
function toQunInfo(id){
    ajaxCallback("findJ",{id:id,table:"qunzu"},function (obj) {
        if(obj){
            ...
            checkIsMyQunzu();
            $("#quntitle").text("Name:"+focusqun.title);
