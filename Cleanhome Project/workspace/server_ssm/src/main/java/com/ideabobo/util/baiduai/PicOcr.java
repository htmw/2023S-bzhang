...
public class PicOcr {
    public static String advancedGeneral() {
        ...
        try {
            ...
            //{"result_num":5,"result":[{"keyword":"杯子","score":0.886584,"root":"家政-容器"},{"keyword":"玻璃杯","score":0.698528,"root":"家政-容器"},{"keyword":"啤酒杯","score":0.513997,"root":"家政-食物"},{"keyword":"红酒杯","score":0.318251,"root":"家政-容器"},{"keyword":"饮水杯","score":0.030615,"root":"家政-容器"}],"log_id":1590895215987910335}
            return result;
        } catch (Exception e) {
            e.printStackTrace();
        }
